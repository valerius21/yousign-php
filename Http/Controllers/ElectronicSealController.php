...
use OpenAPI\Server\Api\ElectronicSealApiInterface;

class ElectronicSealController extends Controller
{
    /**
     * Constructor
     */
    public function __construct(
        private readonly ElectronicSealApiInterface $api,
     ...
     *
     */
    public function getElectronicSeal(Request $request, string $electronicSealId): JsonResponse
    {
        ...
        $apiResult = $this->api->getElectronicSeal($electronicSealId);

        if ($apiResult instanceof \OpenAPI\Server\Model\ElectronicSeal) {
     ...
     *
     */
    public function listElectronicSealImages(Request $request): JsonResponse
    {
        $validator = Validator::make(
            array_merge(
                [
        ...
        $apiResult = $this->api->listElectronicSealImages($after, $limit);

        if ($apiResult instanceof \OpenAPI\Server\Model\ListElectronicSealImages200Response) {
            return response()->json($this->serde->serialize($apiResult, format: 'array'), 200);
        }
     ...
     *
     */
    public function postElectronicSeals(Request $request): JsonResponse
    {
        $validator = Validator::make(
            array_merge(
                [
        ...
        $createElectronicSealPayload = $this->serde->deserialize($request->getContent(), from: 'json', to: \OpenAPI\Server\Model\CreateElectronicSealPayload::class);


        $apiResult = $this->api->postElectronicSeals($createElectronicSealPayload);
