    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Text2., must be smaller than or equal to 128.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Text2., must be bigger than or equal to 1.');
        }
    ...
    public function setDefaultValue($default_value)
    {
        ...
        if (!is_null($default_value) && (mb_strlen($default_value) > 32767)) {
            throw new \InvalidArgumentException('invalid length for $default_value when calling Text2., must be smaller than or equal to 32767.');
        }
        if (!is_null($default_value) && (mb_strlen($default_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $default_value when calling Text2., must be bigger than or equal to 1.');
        }
