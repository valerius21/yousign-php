...
/**
 * WatchlistFullAllOfDataSanctionsRecords Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WatchlistFullAllOfDataSanctionsRecords implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WatchlistFull_allOf_data_sanctions_records';
    ...
    protected static $openAPITypes = [
        ...
        'started_on' => 'string',
        'ended_on' => 'string',
        'sources' => '\OpenAPI\Client\Model\WatchlistFullAllOfDataSanctionsSources[]'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string $description Description of the sanction
     *
     * @return self
     */
     ...
     * Sets authority
     *
     * @param string $authority Authority that issued the sanction
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string $country_code ISO country code where the sanction is applicable
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool $active Whether the sanction is currently active
     *
     * @return self
     */
     ...
     * Sets started_on
     *
     * @param string $started_on Date when the sanction started
     *
     * @return self
     */
     ...
     * Sets ended_on
     *
     * @param string $ended_on Date when the sanction ended − null if ongoing
     *
     * @return self
     */
     ...
     * Gets sources
     *
     * @return \OpenAPI\Client\Model\WatchlistFullAllOfDataSanctionsSources[]
     */
     ...
     * Sets sources
     *
     * @param \OpenAPI\Client\Model\WatchlistFullAllOfDataSanctionsSources[] $sources Sources of this information
     *
     * @return self
     */
