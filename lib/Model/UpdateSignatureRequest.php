...
class UpdateSignatureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'reminder_settings' => '\OpenAPI\Client\Model\UpdateSignatureRequestReminderSettings',
        'timezone' => 'string',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\UpdateSignatureRequestReminderSettings|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UpdateSignatureRequestReminderSettings|null $reminder_settings reminder_settings
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $expiration_date Due date of the Signature Request (yyyy-mm-dd). The date cannot be in the past and cannot be more than one year after initiation.
     *
     * @return self
     */
    ...
    public function setLabels($labels)
    {
        ...
        if ((count($labels) > 50)) {
            throw new \InvalidArgumentException('invalid value for $labels when calling UpdateSignatureRequest., number of items must be less than or equal to 50.');
        }
