...
/**
 * NewSignerFromExistingUser Class Doc Comment
 *
 * @category Class
 ...
 */
class NewSignerFromExistingUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'New_Signer_From_Existing_User';
    ...
    */
    ...
    public function setIdentificationAttestationId($identification_attestation_id)
    {
        ...
        if (!is_null($identification_attestation_id) && (mb_strlen($identification_attestation_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $identification_attestation_id when calling NewSignerFromExistingUser., must be smaller than or equal to 255.');
        }
        if (!is_null($identification_attestation_id) && (mb_strlen($identification_attestation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification_attestation_id when calling NewSignerFromExistingUser., must be bigger than or equal to 1.');
        }
