...
/**
 * CreateApprover Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateApprover implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateApprover';
    ...
    protected static $openAPITypes = [
        ...
        'info' => '\OpenAPI\Client\Model\NewApproverFromScratchInfo',
        'user_id' => 'string',
        'contact_id' => 'string',
        'signer_id' => 'string'
    ];
    ...
    */
     ...
     * Gets custom_text
     *
     * @return \OpenAPI\Client\Model\CustomText|null
     */
     ...
     * Sets custom_text
     *
     * @param \OpenAPI\Client\Model\CustomText|null $custom_text custom_text
     *
     * @return self
     */
     ...
     *
     * @param string|null $insert_after_id ID of the Approver that this Approver follows in the approval sequence. They will only be asked to approve once that previous Approver has approved. Only applicable when `ordered_approvers` is enabled for the Signature Request.
     *
     * @return self
     */
     ...
     * Gets info
     *
     * @return \OpenAPI\Client\Model\NewApproverFromScratchInfo
     */
     ...
     * Sets info
     *
     * @param \OpenAPI\Client\Model\NewApproverFromScratchInfo $info info
     *
     * @return self
     */
