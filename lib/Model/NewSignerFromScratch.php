...
/**
 * NewSignerFromScratch Class Doc Comment
 *
 * @category Class
 ...
 */
class NewSignerFromScratch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'New_Signer_From_Scratch';
    ...
    protected static $openAPITypes = [
        'info' => '\OpenAPI\Client\Model\NewSignerFromScratchInfo',
    ...
    */
     ...
     * Gets info
     *
     * @return \OpenAPI\Client\Model\NewSignerFromScratchInfo
     */
     ...
     * Sets info
     *
     * @param \OpenAPI\Client\Model\NewSignerFromScratchInfo $info info
     *
     * @return self
     */
     ...
     * Sets fields
     *
     * @param \OpenAPI\Client\Model\FieldsInput[]|null $fields Fields to assign to the Signer. Multiple Fields can be added simultaneously.
     *
     * @return self
     */
    ...
    public function setIdentificationAttestationId($identification_attestation_id)
    {
        ...
        if (!is_null($identification_attestation_id) && (mb_strlen($identification_attestation_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $identification_attestation_id when calling NewSignerFromScratch., must be smaller than or equal to 255.');
        }
        if (!is_null($identification_attestation_id) && (mb_strlen($identification_attestation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification_attestation_id when calling NewSignerFromScratch., must be bigger than or equal to 1.');
        }
