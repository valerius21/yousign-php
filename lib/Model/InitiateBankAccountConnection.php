...
/**
 * InitiateBankAccountConnection Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InitiateBankAccountConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitiateBankAccountConnection';
    ...
    */
    ...
    public function setRedirectionUrl($redirection_url)
    {
        ...
        if ((mb_strlen($redirection_url) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $redirection_url when calling InitiateBankAccountConnection., must be smaller than or equal to 2000.');
        }
        if ((mb_strlen($redirection_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirection_url when calling InitiateBankAccountConnection., must be bigger than or equal to 1.');
        }
