...
/**
 * PaginationWithUpdatedAt Class Doc Comment
 *
 * @category Class
 ...
 */
class PaginationWithUpdatedAt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginationWithUpdatedAt';
    ...
    */
    ...
    public function setNextCursor($next_cursor)
    {
        ...
        if (!is_null($next_cursor) && (mb_strlen($next_cursor) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_cursor when calling PaginationWithUpdatedAt., must be bigger than or equal to 1.');
        }
