...
class InitialsArea implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ALIGNMENT_TOP_LEFT = 'top-left';
    public const ALIGNMENT_TOP_RIGHT = 'top-right';
    public const ALIGNMENT_TOP_CENTER = 'top-center';
    public const ALIGNMENT_BOTTOM_LEFT = 'bottom-left';
    public const ALIGNMENT_BOTTOM_RIGHT = 'bottom-right';
    public const ALIGNMENT_BOTTOM_CENTER = 'bottom-center';
    ...
    */
     ...
     * Sets alignment
     *
     * @param string $alignment Alignment of the Initials on the document. The `left`, `right` and `center` options are aligned on top of the page by default.
     *
     * @return self
     */
     ...
     * Sets y
     *
     * @param int $y Offset of the initials from the edge of the page (in pixels). The offset is from the top or bottom of the page, depending on what has been defined in the `alignment` attribute.
     *
     * @return self
     */
