...
class GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 1)) {
            throw new \InvalidArgumentException('invalid value for $height when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 1.');
        }
    ...
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && (mb_strlen($reason) > 150)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 150.');
        }
    ...
    public function setDefaultValue($default_value)
    {
        ...
        if (!is_null($default_value) && (mb_strlen($default_value) > 32767)) {
            throw new \InvalidArgumentException('invalid length for $default_value when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 32767.');
        }
        if (!is_null($default_value) && (mb_strlen($default_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $default_value when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be bigger than or equal to 1.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size > 240)) {
            throw new \InvalidArgumentException('invalid value for $size when calling GetSignatureRequestsSignatureRequestIdDocumentsDocumentIdFields200ResponseDataInner., must be smaller than or equal to 240.');
        }
        if (($size < 8)) {
